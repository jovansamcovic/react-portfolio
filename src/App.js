            ...
            <main className="main">
                <div className="profile">
                    <ul className="social-media">
                        ...
                        <li className="social-media__li">
                          <a className="social-media__a linkedin" href="https://www.linkedin.com/in/jovan-sam%C4%8Dovi%C4%87-753b1b151/"> </a>
                        </li>
                        <li className="social-media__li">
                          <a className="social-media__a github" href="https://github.com/jovansamcovic"> </a>
                        </li>
                    </ul>
                ...
                <div className="contact">
                    ...
                    <div className="contact__box">
                        ...
                        <span className="contact__value">+3816-9-11-04-996</span>
                        <div className="contact__msg">
                          <span className="mr5">Write me</span>
                          <i className="icon icon-right-arrow"></i>
                        </div>
